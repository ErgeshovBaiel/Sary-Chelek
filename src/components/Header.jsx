            ...
            >
                <div className="header-container">
                        ...
                        {isMenuOpen && (
                            ...
                            >
                                {[
                                    ...
                                    <motion.div key={item.to} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: index * 0.05, duration: 0.3 }}>
                                        <NavLink
                                            to={item.to}
                    ...
                    <nav className="desktop-menu">
                        <NavLink to="/" className={getActiveClass} end>{t('main')}</NavLink>
