...
function Nature () {
  ...
  return (
    <div className={styles.page}>
      <h2 className='text-3xl font-medium italic'>{t('of')}</h2>
      <div className='ml-25'>
        <div className='flex gap-35 mt-10'>
          <p className='w-200 mt-15 text-xl italic'>{t('located')}</p>
          <img
        ...
        <div className='flex gap-35 mt-10'>
          <img
            ...
            alt=''
          />
          <p className='w-200 mt-15 text-xl italic'>{t('unique')}</p>
        </div>
        <div className='flex gap-35 mt-10'>
          <p className='w-200 mt-15 text-xl italic'>{t('abundance')}</p>
          <img
            className='w-55 h-35  rounded-2xl relative top-10'
        ...
        <div className='flex gap-35 mt-10'>
          <img
            ...
            alt=''
          />
          <p className='w-200 mt-15 text-xl italic'>{t('contains')}</p>
        </div>
        <div className='flex gap-35 mt-10'>
          <p className='w-200 mt-15 text-xl italic'>{t('designated')}</p>
          <img
            className='w-55 h-35  rounded-2xl relative top-10'
        ...
        <div className='flex gap-35 mt-10'>
          <img
            ...
            alt=''
          />
          <p className='w-200 mt-15 text-xl italic'>{t('hiking')}</p>
        </div>
      </div>
    </div>
  )
